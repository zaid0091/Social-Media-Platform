...
export default function ShareModal({ isOpen, post, onClose, onShareSuccess }) {
  ...
  return (
    ...
    >
      <div 
        ref={modalRef}
        className="bg-white dark:bg-zinc-900 w-full sm:max-w-sm rounded-none sm:rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-2xl p-5 relative flex flex-col text-left h-full sm:h-auto"
        role="dialog"
        aria-modal="true"
